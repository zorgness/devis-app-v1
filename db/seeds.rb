...
c2 = Customer.new(first_name: 'marc', last_name: 'dubois', email: 'marc@gmail.com', address: '19 rue pavillion, Aix-en-Provence', phone: '0666778899', user_id: user1.id)
c2.save
...
User.all.each do |u|
  ...
  p4 = Product.new(user_id: u.id, name: 'parquet', description: 'vasque salle de bain')
  p4.save

  p5 = Product.new(user_id: u.id, name: 'enduit', description: 'vasque salle de bain')
  p5.save
  ...
  e4 = Element.new(user_id: u.id, name: 'mur maître')
  e4.save

  e5 = Element.new(user_id: u.id, name: 'charpente')
  e5.save
  ...
  a5 = Activity.new(user_id: u.id, name: 'tirer')
  a5.save
